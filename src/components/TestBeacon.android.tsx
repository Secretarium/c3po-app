...
export default class IBeaconExample extends Component {
    ...
    componentDidMount() {
        ...
        DeviceEventEmitter.addListener(
            ...
            ({ beacons: updatedBeacons, region }) => {
                ...
                const { beacons } = this.state;
                updatedBeacons.forEach((updatedBeacon: any) => {
                    const index = beacons.findIndex(beacon =>
                        this._isIdenticalBeacon(updatedBeacon, beacon)
                    );
                    this.setState({
                        beacons: beacons.reduce((result: any, val: any, ind) => {
     ...
     */
    _isIdenticalBeacon = (b1: { identifier: any; uuid: any; major: any; minor: any; }, b2: { identifier: any; uuid: any; major: any; minor: any; }) => (
    ...
    _renderBeacons = () => {
        ...
        return this.state.beacons.sort((a: any, b: any) => a.accuracy - b.accuracy).map((beacon: any, ind) => (
